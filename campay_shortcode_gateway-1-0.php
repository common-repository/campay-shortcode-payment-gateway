...
<?php
    ...
    <button data-amount="0" data-buttonid="<?php echo esc_html($button_id) ?>" id="<?php echo uniqid() ?>" class="open_payment_modal"> <?php echo esc_html($button_text)." ".esc_html($amount)." ".  strtoupper(esc_html($currency)); ?></button>
    <?php
    }
    }
    else
    {
        ...
        ?>
        <button data-amount="1" id="<?php echo uniqid() ?>" class="open_payment_modal"><?php echo esc_html($button_text); ?></button>
        <?php
    }
}
?>
  ...
  <div class="modal-content">
    ...
    <form id="campay_shortcode_payment_form" method="post" action="">
        ...
        <fieldset class="wc-campay-gateway" style="background:transparent;">
            ...
            <div class="form-row form-row-wide"><label>Valid MTN or ORANGE Money number <span class="required">*</span></label>
