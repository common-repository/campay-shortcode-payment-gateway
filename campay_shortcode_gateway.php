...
<?php
    ...
    <button data-amount="<?php echo $amount ?>" data-buttonid="<?php echo esc_html($button_id) ?>" id="<?php echo uniqid() ?>" class="open_payment_modal" data-card="0"> <?php echo esc_html($button_text)." ".esc_html($amount)." ".  strtoupper(esc_html($currency)); ?> <span  style="background: url(<?php echo plugins_url( 'assets/img/momo-om.png', __FILE__ ); ?>); width: 50px;height: 20px;display: inline-block;background-size: contain;background-repeat: no-repeat;background-color: #fff;background-position: center center;"></span> </button>
    <button data-amount="<?php echo $amount ?>" data-buttonid="<?php echo esc_html($button_id) ?>"  id="<?php echo uniqid() ?>"  class="pay-using-card" data-card="1" value="campay-card" > <?php echo esc_html($button_text)." ".esc_html($amount)." ".strtoupper(esc_html($currency)); ?> <span  style="background: url(<?php echo plugins_url( 'assets/img/credit-card.png', __FILE__ ); ?>); width: 50px;height: 20px;display: inline-block;background-size: contain;background-repeat: no-repeat;background-color: #fff;background-position: center center;"></span> </button>
    <?php
    }
    }
    else
    { 
        ...
        ?>
        <button data-amount="0" id="<?php echo uniqid() ?>" class="open_payment_modal" data-card="0"><?php echo esc_html($button_text); ?> <span  style="background: url(<?php echo plugins_url( 'assets/img/momo-om.png', __FILE__ ); ?>); width: 50px;height: 20px;display: inline-block;background-size: contain;background-repeat: no-repeat;background-color: #fff;background-position: center center;"></span></button>
        <button data-amount="0" id="<?php echo uniqid() ?>" class="open_payment_modal" value="campay-card" data-card="1" data-buttonid="<?php echo esc_html($button_id) ?>"><?php echo esc_html($button_text); ?> <span  style="background: url(<?php echo plugins_url( 'assets/img/credit-card.png', __FILE__ ); ?>); width: 50px;height: 20px;display: inline-block;background-size: contain;background-repeat: no-repeat;background-color: #fff;background-position: center center;"></span></button>
        <?php
    }
}
?>
...
<!-- The Modal -->
<div id="payment_modal" class="modal" style="overflow-y:auto">
  ...
  <div class="modal-content">
    ...
    <form id="campay_shortcode_payment_form" method="post" action="">
        ...
        <input type="hidden" name="request_type" value="campay_momo_payment">
